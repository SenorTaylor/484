...
<div id="stream">
  ...
  <div id="dashboard">
      <div class="scroll con">
          <div class="section padding current" title="Tables" id="table">
            <table>
              <thead>
                <tr>
                  <th>Name</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td><span class="chrome">Chrome</span></td>
                </tr>
                <tr>
                  <td>Micha Mahomes</td>
                  <td>row 2, cell 2</td>
                  <td><span class="firefox">Firefox</span></td>
                ...
                <tr>
                  <td>Thad Wemhoff</td>
                  <td>row 2, cell 2</td>
                  <td><span class="safari">Safari</span></td>
